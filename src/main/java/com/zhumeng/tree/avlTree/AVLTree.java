...
public class AVLTree<T extends Comparable<T>>  {
    ...
    /*
     * LL：左左对应的情况(左单旋转)。
     *  k2根 节点左子树 左叶 失去平衡， 需要旋转
     *      1、原来根节点的左子节点变为根节点，
     *      2、左子节点的右子节点 作为原来根节点的左子节点，
     *      3、原来根节点变成左子节点的右子节点，
     * 返回值：旋转后的根节点
     */
    private AVLTreeNode<T> leftLeftRotation(AVLTreeNode<T> k2) {
        AVLTreeNode<T> k1;//失去平衡的根节点的 左子节点
    ...
    /*
     * RR：右右对应的情况(右单旋转)。
     * 根节点为k1 的右子树 右叶子节点 失去平衡，需要旋转；
     *      1、原来根节点的右子节点变成根节点，
     *      2、原来右子节点的左子树变成 原来根节点的左子节点，
     *      3、原来的根节点变成 原来右子节点的左子节点
     * 返回值：旋转后的根节点
     */
